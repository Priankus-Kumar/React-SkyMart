...
<NavLink to=""></NavLink>
iske andar maine localstorage se data liya hai or remove bhi kiya hai [localstorage.removeitem()]
--Cart.jsx
...
AUTH
--Signup.jsx
iske andar maine react-hook-form ka use kiya hai
localstorage ke andar maine user ko store karaya hai (signupUser)
fir login ke andar kaam kiya hai [localstorage.setitem(key,value)]
--Login.jsx
iske andar maine react-hook-form ka use kiya hai
localstorage ke andar se compare kara ke login kara hai (signupUser==data) [localstorage.getitem(key)]
